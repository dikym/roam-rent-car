...
if (isset($_POST["submit"])) {
  ...
  header("location: admin_account_setting.php?message=update_account_success");
}
?>
...
<body class="d-flex flex-column h-100">
  <header>
    ...
    if (isset($_GET["message"])) {
      if ($_GET['message'] == "update_account_success") {
        echo "<div class='alert alert-success alert-dismissible fade show text-center m-0' role='alert'>
              Profile update successfully!
              <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close' onclick=\"location.href='admin_account_setting.php'\"></button>
            </div>";
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarToggler">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-lg-end shadow bg-body rounded">
              <li><a class="dropdown-item opacity-75" href="admin_account_profile.php">Profiles</a></li>
              <li><a class="dropdown-item fw-semibold" href="admin_account_setting.php">Settings</a></li>
  ...
  <main class="container">
    <h1 class="m-5 display-5 text-center">Admin Account Settings</h1>
    ...
    <div class="d-flex justify-content-center m-0">
      <div class="p-1">
        ...
        <form method="post" class="row g-3" autocomplete="off">
          ...
          <div class="d-flex">
            <a href="admin_account_delete.php?id=<?= $_SESSION["id"] ?>" class="btn btn-danger me-auto text-decoration-none" onclick="return confirm('Account will delete permanently, are you sure?');">Delete account</a>
