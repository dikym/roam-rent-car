...
<body class="d-flex flex-column h-100">
        ...
        <div class="collapse navbar-collapse" id="navbarToggler">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-lg-end shadow">
              <li><a class="dropdown-item fw-semibold" href="admin_account_profile.php">Profiles</a></li>
              <li><a class="dropdown-item opacity-75" href="admin_account_setting.php">Settings</a></li>
              <li><a class="dropdown-item opacity-75" href="../../auth/logout.php">Logout</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li>
                <a class="dropdown-item opacity-75" href="../../user/user_home.php">Switch to User</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <main class="container">
    <h1 class="m-5 display-5 text-center">Admin Account Profiles</h1>
