              ...
              <?php if (mysqli_num_rows($cars) > 0) : ?>
                <?php foreach ($cars as $row) : ?>
                  <tr align="center">
                    ...
                    <td>
                      <?php if ($row["status"] == "available") : ?>
                        <button type="button" class="btn btn-primary btn-sm btn-order" data-bs-target="#orderModal" data-bs-toggle="modal" data-id="<?= $row["id_mobil"]; ?>">Pesan sekarang</button>
                      <?php else : ?>
                        <button type="button" class="btn btn-primary btn-sm" disabled>Pesan sekarang</button>
                      <?php endif; ?>
                    </td>
                  </tr>
                <?php endforeach; ?>
