    ...
    if (isset($_GET['message'])) {
      if ($_GET['message'] == "invalid_access") {
        echo "<div class='alert alert-danger alert-dismissible fade show text-center m-0' role='alert'>
              ...
              <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close' onclick=\"location.href='user_home.php'\"></button>
            </div>";
      }
    }
    ?>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarToggler">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active fw-semibold" aria-current="page" href="user_home.php">Home</a>
            </li>
            <li class="nav-item">
  ...
  <main class="container">
    <div class="bd-masthead mb-3">
      <div class="col-md-8 mx-auto text-center">
        ...
        <h1 class="mb-3 fw-semibold lh-1">Roam with style, rent with&nbsp;Roam</h1>
      </div>
    </div>
  </main>
